    ...
    */
    ...
    public function login(Request $request) 
    {
        ...
        if ($this->guard()->validate($this->credentials($request))) {
            ...
            if ($user->active && $user->otpactive && $this->attemptLogin($request)) {
                // Send the normal successful login response
                return $this->sendLoginResponse($request);
            } elseif(!$user->otpactive && $user->active) {
                session(['user' => $user]);
                ...
                return redirect()
                    ...
                    ->withErrors(['active' => 'Your account is not activated yet, please activate it by clicking on link sent in email.']);
            }
        }
